...
<body>
    <div>
        <form action="" method="POST" style="height: auto; width: 500px;">
            ...
            <input type="text" name="txtMaTinTuc" placeholder="Nhập mã tin tức" value="<?php echo $rowSelectTinTuc['matintuc'] ?>"readonly>
            <br>

            <label for="txtTieuDe">Tiêu đề</label>
            <input type="text" name="txtTieuDe" placeholder="Nhập tiêu đề" value="<?php echo $rowSelectTinTuc['tieude'] ?>" required>
            <br>
            ...
            <textarea name="txtNoiDung" id="" placeholder="Nhập nội dung" style="height=60px ;width: 500px;" ><?php echo $rowSelectTinTuc['noidung'] ?></textarea>
            <br>

            <label for="selectLoaiTin">Loại tin</label>
            <select name="selectLoaiTin" id="">
                <option value="Khuyến mại" <?php if($rowSelectTinTuc['loaitin']=='Khuyến mại'){echo 'selected';} ?>>Khuyến mại</option>
                <option value="Thông báo" <?php if($rowSelectTinTuc['loaitin']=='Thông báo'){echo 'selected';} ?>>Thông báo</option>
                <option value="Tuyển dụng" <?php if($rowSelectTinTuc['loaitin']=='Tuyển dụng'){echo 'selected';} ?>>Tuyển dụng</option>
                <option value="Khác" <?php if($rowSelectTinTuc['loaitin']=='Khác'){echo 'selected';} ?>>Khác</option>
            </select>
            <br>
