    ...
    if ($ma_kh == "" || $ho_ten == "" || $sdt == "") {
        ...
        if (mysqli_num_rows($resultCheck) > 0) {
            ...
            if (mysqli_query($con, $sql)) {
                echo "<script>alert('$msg'); window.location='khachhang.php';</script>";
            } else {
...
if (isset($_GET['btnXoa'])) {
    ...
    if (mysqli_query($con, $sqlDelete)) {
        echo "<script>alert('Xóa thành công!'); window.location='khachhang.php';</script>";
    } else {
        ...
        <div class="col-md-4">
            <div class="form-section">
                ...
                <form action="khachhang.php" method="POST">
                    ...
                    <button type="submit" name="btnLuu" class="btn btn-primary w-100">
                        <?php echo $is_editing ? "💾 Cập nhật" : "➕ Thêm mới"; ?>
                    </button>
                    
                    <?php if($is_editing): ?>
                        <a href="khachhang.php" class="btn btn-secondary w-100 mt-2">❌ Hủy bỏ</a>
                    <?php endif; ?>
                </form>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $row['diachi']; // Lưu ý: Tên cột trong DB là 'diachi' hay 'dia_chi'? Kiểm tra lại nhé ?></td>
                            <td>
                                <a href="khachhang.php?btnSua=1&id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm">Sửa</a>
                                
                                <a href="khachhang.php?btnXoa=1&id=<?php echo $row['id']; ?>" 
